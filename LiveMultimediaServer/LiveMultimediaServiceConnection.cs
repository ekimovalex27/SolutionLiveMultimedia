...
namespace LiveMultimediaServer
{
  ...
  {
    public static readonly string AccountKey = "***";
    ...
    public static string Language
    {
      get
      {
        if (LiveMultimediaLibrary.CheckGoodString((string)localSettings.Values["Language"]))
        {
    ...
    public static string AccessListToken
    {
      get
      {
        return (string)localSettings.Values["token"];
      }
      set
      {
...
#if (RELEASE)
    //private HttpsTransportBindingElement _binding;
...
#if (RELEASE)
    //public HttpsTransportBindingElement Binding
    ...
    {
#if (RELEASE)
      //_binding = new HttpsTransportBindingElement();
